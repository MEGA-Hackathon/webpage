...
export default function Navbar({ updateSidenav, sidenavState }) {
  return (
    <MDBNavbar id="main-navbar" expand="lg" light fixed="top" bgColor="light">
      <MDBContainer fluid>
        <MDBBtn onClick={() => updateSidenav(!sidenavState)} className="shadow-0 p-0 me-3 d-block d-xxl-none" color="light">
          <MDBIcon icon="bars" size="lg" fas />
        </MDBBtn>

        <MDBInputGroup className="d-none d-md-flex w-auto my-auto">
          <MDBInputGroupElement
            type="search"
            placeholder='Search (ctrl + "/" to focus)'
            style={{ minWidth: "225px" }}
          />
          <MDBInputGroupText className="border-0">
