...
declare const MDBSelect: React$1.FunctionComponent<{
  className?: string;
  pill?: boolean;
  dot?: boolean;
  notification?: boolean;
...
declare const MDBScrollbar: React$1.FunctionComponent<{
  className?: string;
  tag?: React$1.ComponentProps<any>;
  sidenav?: boolean;
...
declare const MDBSideNav: React$1.FunctionComponent<{
  className?: string;
  color?: string;
  isOpen?: boolean;
  light?: boolean;
...
declare const MDBSideNavMenu: React$1.FunctionComponent<{
  className?: string;
  [rest: string]: any;
}>;

declare const MDBSideNavItem: React$1.FunctionComponent<{
  className?: string;
  [rest: string]: any;
}>;

declare const MDBSideNavLink: React$1.FunctionComponent<{
  className?: string;
  iconAngle?: number;
...
declare const AnimationProps: React$1.FunctionComponent<{
  animation?: string;
  animationRef?: React$1.RefObject<HTMLElement>;
  runOnce?: boolean;
  delay?: number;
  reset?: boolean;
  duration?: number;
...
declare const MDBTimepicker: React$1.FunctionComponent<{
  className?: string;
  customValue?: string;
  inputLabel?: string;
  invalidLabel?: string;
...
declare const MDBDatepicker: React$1.FunctionComponent<{
  closeOnEsc?: boolean;
  ...
  options?: any;
  value: string;
  setValue: React$1.SetStateAction<any>;
  clearBtnText?: string;
  cancelBtnText?: string;
  okBtnText?: string;
  inputToggle?: boolean;
  icon?: React$1.ReactChild;
  inputLabel?: string;
...
declare const MDBAlert: React$1.FunctionComponent<{
  className?: string;
...
declare const MDBToast: React$1.FunctionComponent<{
  className?: string;
  position?: 'top-left' | 'top-center' | 'top-right' | 'bottom-left' | 'bottom-center' | 'bottom-right';
  color?: string;
  width?: number | number;
...
declare const MDBDatatable: React$1.FunctionComponent<{
  advancedSearch?: any;
...
declare const MDBChart: React$1.FunctionComponent<{
  type: 'bar' | 'line' | 'pie' | 'doughnut' | 'polarArea' | 'radar' | 'bubble' | 'scatter';
  options?: Record<string, unknown>;
  [rest: string]: any;
}>;

declare const MDBStepper: React$1.FunctionComponent<{
  className?: string;
  linear?: boolean;
  formWizard?: boolean;
  noEditable?: boolean;
  ...
  outerState?: number;
  setOuterState?: React$1.SetStateAction<any>;
  prevOuterState?: number;
  setPrevOuterState?: React$1.SetStateAction<any>;
  vertical?: boolean;
...
declare const MDBStepperContent: React$1.FunctionComponent<{
  className?: string;
  tag?: React$1.ComponentProps<any>;
  [rest: string]: any;
}>;

declare const MDBStepperHead: React$1.FunctionComponent<{
  className?: string;
  icon?: any;
  text?: string;
  tag?: React$1.ComponentProps<any>;
...
declare const MDBStepperStep: React$1.FunctionComponent<{
  className?: string;
  itemId: number;
  tag?: React$1.ComponentProps<any>;
  [rest: string]: any;
...
declare const MDBStepperForm: React$1.FunctionComponent<{
  className?: string;
  tag?: React$1.ComponentProps<any>;
  [rest: string]: any;
}>;

declare const MDBRating: React$1.FunctionComponent<{
  className?: string;
  active?: number;
  dynamic?: boolean;
  setActive?: React$1.SetStateAction<any>;
  tag?: React$1.ComponentProps<any>;
  [rest: string]: any;
}>;

declare const MDBRatingElement: React$1.FunctionComponent<{
  className?: string;
  color?: string;
  itemId?: number;
...
declare const MDBTouch: React$1.FunctionComponent<{
  tag?: React$1.ComponentProps<any>;
...
declare const MDBLazyLoading: React$1.FunctionComponent<{
  className?: string;
  video?: boolean;
  lazyOffset?: number;
  lazySrc?: string;
...
declare const MDBLazyContainer: React$1.FunctionComponent<{
  [rest: string]: any;
}>;

declare const MDBInfiniteScroll: React$1.FunctionComponent<{
  tag?: React$1.ComponentProps<any>;
...
declare const MDBSticky: React$1.FunctionComponent<{
  className?: string;
  pill?: boolean;
  dot?: boolean;
  notification?: boolean;
...
declare const MDBLoadingManagement: React$1.FunctionComponent<{
...
declare const MDBAutocomplete: React$1.FunctionComponent<{
  className?: string;
  customContent?: any;
  dataFilter: any;
  displayValue?: any;
  ...
  itemContent?: any;
  noResults?: string;
  setInputValue?: React$1.SetStateAction<any>;
  threshold?: number;
  tag?: React$1.ComponentProps<any>;
  [rest: string]: any;
}>;
...
declare const MDBSmoothScroll: React$1.FunctionComponent<{
  className?: string;
  containerRef?: any;
  duration?: number;
  easing?: any;
...
declare const MDBLightbox: React$1.FunctionComponent<{
  className?: string;
...
declare const MDBLightboxItem: React$1.FunctionComponent<{
  className?: string;
...
export { MDBAccordion, MDBAccordionItem, MDBAlert, MDBAnimatedNavbar, AnimationProps as MDBAnimation, MDBAutocomplete, MDBBadge, MDBBreadcrumb, MDBBreadcrumbItem, MDBBtn, MDBBtnGroup, MDBCard, MDBCardBody, MDBCardFooter, MDBCardGroup, MDBCardHeader, MDBCardImage, MDBCardLink, MDBCardOverlay, MDBCardSubTitle, MDBCardText, MDBCardTitle, MDBCarousel, MDBCarouselCaption, MDBCarouselElement, MDBCarouselInner, MDBCarouselItem, MDBChart, MDBCheckbox, MDBCol, MDBCollapse, MDBContainer, MDBDatatable, MDBDatepicker, MDBDropdown, MDBDropdownDivider, MDBDropdownHeader, MDBDropdownItem, MDBDropdownLink, MDBDropdownMenu, MDBDropdownToggle, MDBFile, MDBFooter, MDBIcon, MDBInfiniteScroll, MDBInput, MDBInputGroup, MDBInputGroupElement, MDBInputGroupText, MDBLazyContainer, MDBLazyLoading, MDBLightbox, MDBLightboxItem, MDBListGroup, MDBListGroupItem, MDBLoadingManagement, MDBModal, MDBModalBody, MDBModalContent, MDBModalDialog, MDBModalFooter, MDBModalHeader, MDBModalTitle, MDBNavbar, MDBNavbarBrand, MDBNavbarItem, MDBNavbarLink, MDBNavbarNav, MDBNavbarToggler, MDBPagination, MDBPaginationItem, MDBPaginationLink, MDBPopconfirm as MDBPopcofirm, MDBPopconfirmMessage, MDBPopover, MDBPopoverBody, MDBPopoverHeader, MDBProgress, MDBProgressBar, MDBRadio, MDBRange, MDBRating, MDBRatingElement, MDBRipple, MDBRow, MDBScrollbar, MDBScrollspy, MDBScrollspyNavItem, MDBScrollspyNavLink, MDBScrollspyNavList, MDBScrollspySection, MDBSelect, MDBSideNav, MDBSideNavCollapse, MDBSideNavItem, MDBSideNavLink, MDBSideNavMenu, MDBSmoothScroll, MDBSpinner, MDBStepper, MDBStepperContent, MDBStepperForm, MDBStepperHead, MDBStepperStep, MDBSticky, MDBSwitch, MDBTable, MDBTableBody, MDBTableHead, MDBTabs, MDBTabsContent, MDBTabsItem, MDBTabsLink, MDBTabsPane, MDBTimepicker, MDBToast, MDBTooltip, MDBTouch, MDBTypography, MDBValidation };
